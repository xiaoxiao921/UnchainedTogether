...
struct ALS_Animation_BPI_C_SetActorComponentToPull final
{
public:
...
static_assert(alignof(ALS_Animation_BPI_C_SetActorComponentToPull) == 0x000008, "Wrong alignment on ALS_Animation_BPI_C_SetActorComponentToPull");
static_assert(sizeof(ALS_Animation_BPI_C_SetActorComponentToPull) == 0x000008, "Wrong size on ALS_Animation_BPI_C_SetActorComponentToPull");
static_assert(offsetof(ALS_Animation_BPI_C_SetActorComponentToPull, Comp) == 0x000000, "Member 'ALS_Animation_BPI_C_SetActorComponentToPull::Comp' has a wrong offset!");

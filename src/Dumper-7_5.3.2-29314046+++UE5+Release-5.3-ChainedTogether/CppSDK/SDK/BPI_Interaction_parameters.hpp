...
static_assert(offsetof(BPI_Interaction_C_CanBeUsed, CanBeUsed_0) == 0x000000, "Member 'BPI_Interaction_C_CanBeUsed::CanBeUsed_0' has a wrong offset!");
...
static_assert(offsetof(BPI_Interaction_C_Detected, Detected_0) == 0x000000, "Member 'BPI_Interaction_C_Detected::Detected_0' has a wrong offset!");

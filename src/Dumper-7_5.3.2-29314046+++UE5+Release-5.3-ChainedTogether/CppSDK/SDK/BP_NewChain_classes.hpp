...
public:
	...
	void ChangeMaillonMasses(double MassInKg, double LinearDamping_0, double AngularDamping_0);
	...
	void PullChain(class APawn* Puller_0);
	void PullOnChain();
	...
	void ReinitAttachment(int32 NewDensity, double NewChainMass, bool Human_0);

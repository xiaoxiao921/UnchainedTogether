...
public:
	...
	uint8                                         Pad_27F4[0x7];                                     // 0x0211(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_27F5[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_27F6[0x28];                                    // 0x0088(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_27F7[0xB0];                                    // 0x0028(0x00B0)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_27F8[0x18];                                    // 0x01C8(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

...
public:
	...
	class UW_LeaderboardSwitcher_C*               CallFunc_Create_ReturnValue;                       // 0x0010(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UW_SettingsMain_C*                      CallFunc_Create_ReturnValue_1;                     // 0x0018(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UAudioComponent*                        CallFunc_SpawnSound2D_ReturnValue_2;               // 0x0058(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UPlayMenu_W_C*                          CallFunc_Create_ReturnValue_2;                     // 0x0060(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(MainMenu_W_C_ExecuteUbergraph_MainMenu_W) == 0x000068, "Wrong size on MainMenu_W_C_ExecuteUbergraph_MainMenu_W");
...
static_assert(offsetof(MainMenu_W_C_ExecuteUbergraph_MainMenu_W, CallFunc_SpawnSound2D_ReturnValue) == 0x000008, "Member 'MainMenu_W_C_ExecuteUbergraph_MainMenu_W::CallFunc_SpawnSound2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(MainMenu_W_C_ExecuteUbergraph_MainMenu_W, CallFunc_Create_ReturnValue) == 0x000010, "Member 'MainMenu_W_C_ExecuteUbergraph_MainMenu_W::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(MainMenu_W_C_ExecuteUbergraph_MainMenu_W, CallFunc_Create_ReturnValue_1) == 0x000018, "Member 'MainMenu_W_C_ExecuteUbergraph_MainMenu_W::CallFunc_Create_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(MainMenu_W_C_ExecuteUbergraph_MainMenu_W, CallFunc_SpawnSound2D_ReturnValue_1) == 0x000050, "Member 'MainMenu_W_C_ExecuteUbergraph_MainMenu_W::CallFunc_SpawnSound2D_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(MainMenu_W_C_ExecuteUbergraph_MainMenu_W, CallFunc_SpawnSound2D_ReturnValue_2) == 0x000058, "Member 'MainMenu_W_C_ExecuteUbergraph_MainMenu_W::CallFunc_SpawnSound2D_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(MainMenu_W_C_ExecuteUbergraph_MainMenu_W, CallFunc_Create_ReturnValue_2) == 0x000060, "Member 'MainMenu_W_C_ExecuteUbergraph_MainMenu_W::CallFunc_Create_ReturnValue_2' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_31FC[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])

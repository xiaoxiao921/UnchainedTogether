...
static_assert(sizeof(V_GameInstanceWithSave_C_ApplyAntialiasing) == 0x000003, "Wrong size on V_GameInstanceWithSave_C_ApplyAntialiasing");
...
static_assert(offsetof(V_GameInstanceWithSave_C_ApplyAntialiasing, K2Node_SwitchString_CmpSuccess_1) == 0x000002, "Member 'V_GameInstanceWithSave_C_ApplyAntialiasing::K2Node_SwitchString_CmpSuccess_1' has a wrong offset!");

...
public:
	...
	EButtons_E                                    Temp_byte_Variable;                                // 0x0004(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_SpawnSound2D_PitchMultiplier_ImplicitCast; // 0x0078(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText) == 0x000080, "Wrong size on W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText");
...
static_assert(offsetof(W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText, Temp_byte_Variable) == 0x000004, "Member 'W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText, Temp_object_Variable) == 0x000008, "Member 'W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText, Temp_object_Variable_1) == 0x000010, "Member 'W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText::Temp_object_Variable_1' has a wrong offset!");
static_assert(offsetof(W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText, Temp_object_Variable_2) == 0x000018, "Member 'W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText::Temp_object_Variable_2' has a wrong offset!");
static_assert(offsetof(W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText, K2Node_Event_IsDesignTime) == 0x000020, "Member 'W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText, K2Node_MakeStruct_SlateColor) == 0x000024, "Member 'W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText::K2Node_MakeStruct_SlateColor' has a wrong offset!");
static_assert(offsetof(W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText, K2Node_Select_Default) == 0x000038, "Member 'W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText, CallFunc_PlayAnimation_ReturnValue) == 0x000040, "Member 'W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText, CallFunc_PlayAnimation_ReturnValue_1) == 0x000048, "Member 'W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText::CallFunc_PlayAnimation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText, CallFunc_RandomFloatInRange_ReturnValue) == 0x000050, "Member 'W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText::CallFunc_RandomFloatInRange_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText, K2Node_CustomEvent_InText) == 0x000058, "Member 'W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText::K2Node_CustomEvent_InText' has a wrong offset!");
static_assert(offsetof(W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText, CallFunc_SpawnSound2D_ReturnValue) == 0x000070, "Member 'W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText::CallFunc_SpawnSound2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText, CallFunc_SpawnSound2D_PitchMultiplier_ImplicitCast) == 0x000078, "Member 'W_MenuButtonText_C_ExecuteUbergraph_W_MenuButtonText::CallFunc_SpawnSound2D_PitchMultiplier_ImplicitCast' has a wrong offset!");
...
struct W_MenuButtonText_C_SetText final
{
public:
	class FText                                   InText;                                            // 0x0000(0x0018)(BlueprintVisible, BlueprintReadOnly, Parm)
};
static_assert(alignof(W_MenuButtonText_C_SetText) == 0x000008, "Wrong alignment on W_MenuButtonText_C_SetText");
static_assert(sizeof(W_MenuButtonText_C_SetText) == 0x000018, "Wrong size on W_MenuButtonText_C_SetText");
static_assert(offsetof(W_MenuButtonText_C_SetText, InText) == 0x000000, "Member 'W_MenuButtonText_C_SetText::InText' has a wrong offset!");

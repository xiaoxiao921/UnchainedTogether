...
public:
	...
	class UEditableTextBox*                       EditableTextBox_101;                               // 0x02D8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UImage*                                 Image_165;                                         // 0x02E0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(offsetof(UW_PasswordSession_C, Cancel_Button) == 0x0002D0, "Member 'UW_PasswordSession_C::Cancel_Button' has a wrong offset!");
static_assert(offsetof(UW_PasswordSession_C, EditableTextBox_101) == 0x0002D8, "Member 'UW_PasswordSession_C::EditableTextBox_101' has a wrong offset!");
static_assert(offsetof(UW_PasswordSession_C, Image_165) == 0x0002E0, "Member 'UW_PasswordSession_C::Image_165' has a wrong offset!");
static_assert(offsetof(UW_PasswordSession_C, W_Button) == 0x0002E8, "Member 'UW_PasswordSession_C::W_Button' has a wrong offset!");
